...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('listGradesview') }}">Grades</a></li>
        ...
        <div class="container mt-5">
            <h1>Edit Grade</h1>
            <form action="{{ route('updateGradesview', $grade->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <a href="{{ route('listGradesview') }}" class="btn btn-secondary">Back</a>
            </form>
        </div>
        <!-- /.content -->
    </div>
