        ...
        <div class="content">
            <div class="container mt-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('createGradesview') }}" class="btn btn-primary">Add Grade</a>
                </div>
                            ...
                            <tbody>
                                @foreach ($grades as $grade)
                                    <tr>
                                        ...
                                        <td>{{ $grade->grade }}</td>
                                        <td>
                                            <a href="{{ route('showGradesview', $grade) }}"
                                                class="btn btn-info btn-sm">View</a>
                                            <a href="{{ route('editGradesview', $grade) }}"
                                                class="btn btn-warning btn-sm">Edit</a>
                                            <a href="#" onclick="confirmDelete(this)"
                                                data-url="{{ route('deleteGradesview', ['grade' => $grade->id]) }}"
