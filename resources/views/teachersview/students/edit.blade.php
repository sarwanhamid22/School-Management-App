    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('listStudentsview') }}">Students</a></li>
        ...
        <div class="content">
            <div class="container mt-5">
                ...
                <form action="{{ route('updateStudentsviews', $student) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <a href="{{ route('listStudentsview') }}" class="btn btn-secondary">Back</a>
                </form>
            </div>
        </div>
        <!-- /.content -->
