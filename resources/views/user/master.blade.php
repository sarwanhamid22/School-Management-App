            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('listindexStudents') }}"
                      class="nav-link {{ Request::is('user/indexstudent') ? 'active' : '' }}">
                      <p>Kelola Profil Siswa</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('listAttendancesstudent') }}"
                      class="nav-link {{ Request::is('user/attendancesstudent*') ? 'active' : '' }}">
                      <p>Kelola Kehadiran Siswa</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('listgradeStudents') }}" class="nav-link {{ Request::is('user/gradestudent*') ? 'active' : '' }}">
                      <p>Kelola Nilai Siswa</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('reports.create') }}"
                      class="nav-link {{ Request::is('user/reports/create*') ? 'active' : '' }}">
                      <p>Kelola Laporan</p>
                    </a>
                  </li>
                </ul>
